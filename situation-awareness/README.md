...
Per [Wikipedia](https://en.wikipedia.org/wiki/Situation_awareness), **Situation Awareness** (SA) is defined in multiple ways, such as:
* the understanding of an environment, its elements, and how it changes with respect to time or other factors
