...
There is an unfortunate **name clash** between two cyber-security that have both been named UCO. This is why, in DISO, the folders (entries) for these two ontologies are named `UCO_1` and `UCO_2`.
